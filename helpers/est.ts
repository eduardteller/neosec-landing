export const landingPage = {
  heading: {
    titleFirst: "Kindlusta Oma Tulevik:",
    titleSecond: "Alusta Täna.",
    subtitle: "Purunematu küberturvalisus.",
    paragraph: `Kaitseme teie digimaailma seal, kus teised ebaõnnestuvad—pakume
            turvalisust, mis toimib ka kõige keerulisemates tingimustes.`,
    contactButton: "KONTAKT",
    button: "teenused",
  },
  firstSection: {
    topText: "Võimatust reaalsuseks",
    titleFirst: "Täpsus tegudes",
    titleSecond: "Võimsus globaalses ulatuses",
    paragraph: `NeoSec on ekspert kõrge panusega uurimistes, digitaalsetes ohuluureteenustes, jalajälgede kustutamises ja vara taastamises. Meie eliitspetsialistid ja tipptasemel tehnoloogia leiavad tõendid, mida teised ei näe.
  ...
  secondSection: {
    topText: "Kuldstandardi kehtestamine",
    titleFirst: "Tõestatud Asjatundlikkus",
    titleSecond: "Milles Võid Kindel Olla",
    paragraph: `NeoSec on küberturbe esirinnas, arendades väsimatult oma meetodeid, et edestada tekkivaid ohte. Meie pühendumus uuendustegevusele tagab, et teie organisatsioon püsib kaitstuna tänapäevaseima tehnoloogiaga.`,
  },
  thirdSection: {
    topText: "teenused",
    titleFirst: "Mitmekesised Tööstusharud",
    titleSecond: "Kohandatud Lahendused",
    paragraph: `Saavuta Täielik Küberturbe Meisterlikkus meie kõikehõlmavate lahendustega. Alates digitaalse jalajälje eemaldamisest ja eritellimusel valmistatud digitaalse kaitse teenustest kuni arenenud küberohtude luureandmeteni - me tagame, et teie organisatsiooni digitaalne kindlus on läbimatu.`,
    servicesButton: "Loe Lähemalt",
    services: [
      {
        title: "Küberohtude Luure",
        link: "/services#section1",
      },
      {
        title: "Digitaalse Kaitse Concierge-teenus",
        link: "/services#section2",
      },
      {
        title: "Digitaalse Jalajälje Eemaldamine",
        link: "/services#section3",
      },
      {
        title: "Küberuurimised ja Vara Tagasisaamine",
        link: "/services#section4",
      },
    ],
  },
  fourthSection: {
    topText: "Lahendused Kõigile",
    titleFirst: "Võimestame",
    titleSecond: "Iga Tööstusharu",
    paragraph: `NeoSec pakub tipptasemel luurelahendusi, mis annavad käegakatsutavaid tulemusi juriidikas, rahanduses, valitsuses, tervishoius, energias, tehnoloogias ja jaekaubanduses. Oleme teie usaldusväärne partner edu saavutamisel ja konkurentsieelise tagamisel.`,
    services: [
      {
        title: "Valitsus",
        description:
          "Aidates valitsusasutustel ennetada riske kriitilistes otsustusprotsessides.",
      },
      {
        title: "Telekommunikatsioon",
        description:
          "Täpne ülevaade ohustsenaariumidest ja andmekaitse tugevdamiseks.",
      },
      {
        title: "Tervishoid",
        description:
          "Patsiendiandmete turvalisus ja tervishoiuteenuste tõrgeteta toimimine.",
      },
      {
        title: "Krüpto",
      ...
      },
      {
        title: "rahandus",
        description:
          "Tugimeetmed turvalise andmeanalüüsi ja finantskuritegude ennetamiseks.",
      },
      {
        title: "fintech",
        description:
          "Innovaatilised lahendused finantstehnoloogia ettevõtete turvalisuse tagamiseks.",
      },
      {
        title: "energia",
        description:
          "Energiasektori kriitilise infrastruktuuri kaitsmine tänapäevaste ohtude eest.",
      },
      {
        title: "õigusvaldkond",
        description:
          "Toetame õiguskaitse ja vastavusnõuete täitmist kaasaegsete tehnoloogiatega.",
      },
    ],
  },
  fifthSection: {
    titleFirst: "Avasta Ülim",
    titleSecond: "Kaitse",
    paragraph: `Kaitse oma kõige väärtuslikumaid varasid NeoSeci eliitluureteenustega. Võta meiega ühendust juba täna, et tagada ületamatu kaitse!`,
    contactButton: "KONTAKT",
  },
};
...
export const servicesPage = {
  heading: {
    topText: "teenused",
    titleFirst: "Avasta Meie",
    titleSecond: "Teenused",
    subtitle:
  ...
  firstSection: {
    ...
    items: [
      ...
      {
        firstText: "Kirjavigade Kuritarvitused ja Homoglüüfi Rünnakud",
  ...
  secondSection: {
    titleFirst: "Digitaalse Kaitse",
    titleSecond: "Concierge-teenus",
    items: [
      {
  ...
  thirdSection: {
    titleFirst: "Digitaalse Jalajälje",
    titleSecond: "Eemaldamine",
    items: [
      {
  ...
  fourthSection: {
    titleFirst: "Küberuurimised ja Vara",
    titleSecond: "Tagasisaamine",
    items: [
      {
...
export const contactPage = {
  heading: {
    topText: "Kontakt",
    titleFirst: "Võtke",
    titleSecond: "Ühendust",
    subtitle: "Küberkaitse tipplahendused teie ettevõtte kindlustamiseks.",
  },
  mainSection: {
    titleFirst: "Võta meiega ühendust",
    titleSecond: "juba täna!",
  ...
  form: {
    ...
    contactType: {
      title: "Kuidas võtta teiega ühendust?",
      placeholder: "Soovin, et minuga võetakse ühendust...",
    },
    telegram: {
      title: "TELEGRAM",
    ...
    button: "Saada sõnum",
    success: "Teie kiri on edukalt saadetud!",
    failure: "Kirja saatmine ebaõnnestus!\nPalun proovige hiljem uuesti.",
  },
};

export type ContactFormText = typeof contactPage.form;
